...
public class MainActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private static final String[] PERMISSIONS = new String[]{
            android.Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest.permission.WRITE_EXTERNAL_STORAGE,android.Manifest.permission.RECORD_AUDIO,android.Manifest.permission.CAMERA};
    public static final int RESULTCODE_110=110;
    @Override
...
//        });
    ...
    private boolean prepareMediaRecorder() {
        ...
        if (path != null) {
            ...
            File dir = new File(path + "/"+Utils.FILENAME);
            if (!dir.exists()) {
                dir.mkdirs();
            }
